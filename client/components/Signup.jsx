        ...
        <div>
          ...
          <form onSubmit={signup}>
           <label>First Name</label>
             <input onChange={(e) => dispatch(firstNameInputActionCreator(e.target.value))} />
            <label>Last Name</label>
             <input onChange={(e) => dispatch(lastNameInputActionCreator(e.target.value))} />
            <label>Email</label>
             <input type="email" onChange={(e) => dispatch(emailInputActionCreator(e.target.value))} />
